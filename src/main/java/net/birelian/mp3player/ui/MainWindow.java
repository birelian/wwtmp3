...
public class MainWindow {
	...
	/** Event manager */
	private final EventManager eventManager = new EventManager(this, visualPlayList, playerManager, displayUpdater);	
	...
	private void initialize() {
		...
		frmWwteamMpPlayer.getContentPane().setBackground(new Color(240,240,240));
		...
		// Font
		try {
			displayFont = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/fonts/freak.ttf")).deriveFont(Font.PLAIN, 24);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		// Play button
		btnPlay.setIcon(new ImageIcon(MainWindow.class.getResource("/icons/play35.png")));
		...
		// Stop button
		btnStop.setIcon(new ImageIcon(MainWindow.class.getResource("/icons/stop35.png")));
		...
		// Previous button
		btnPrevious.setIcon(new ImageIcon(MainWindow.class.getResource("/icons/previous35.png")));
		...
		// Next button
		btnNext.setIcon(new ImageIcon(MainWindow.class.getResource("/icons/next35.png")));
		...
		// Add button
		btnPlaylist.setIcon(new ImageIcon(MainWindow.class.getResource("/icons/list35.png")));
