...
public class EventManager {
     ...
     *            Display updater
     */
    public EventManager(MainWindow mainWindow, VisualPlayList visualPlayList,
            PlayerManager playerManager, DisplayUpdater displayUpdater) {
    ...
    public void startedPlaying() {
        if (playerManager.getSongManager().getCurrentSong() != null) {
            ...
            mainWindow.getBtnPlay().setIcon(
                    new ImageIcon(MainWindow.class
                            .getResource("/icons/pause35.png")));
        }
    }
    ...
    public void stoppedPlaying() {
        ...
        visualPlayList.highlightPlayingSong(playerManager.getSongManager()
                .getCurrentSong());
    }
